...
import { Calendar, MapPin, Phone, Mail, Star, ArrowRight, Package, IndianRupee, User } from 'lucide-react';
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:space-x-6">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="grid grid-cols-4 md:grid-cols-5 gap-4 mb-6">
                                ...
                                <Link to={`/product-details`} state={{ productId: rental.product._id }}>
                                    <button
                                        onClick={() => setIsReviewModalOpen(true)}
                                        className="bg-gradient-to-r from-emerald-500 to-yellow-600 text-white font-semibold py-2 px-6 rounded-lg shadow-md transform transition-all duration-300 ease-in-out hover:from-emerald-600 hover:to-yellow-700 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2"
                                    >
                                        Rent Again
                                    </button>
                                </Link>
...
const EmptyState = ({ type }) => (
    <div className="text-center py-12">
        ...
        <Link
            to="/browse"
            className="mt-6 inline-flex items-center px-6 py-2 border border-transparent rounded-lg shadow-sm text-base font-medium text-white bg-gradient-to-r from-emerald-600 to-teal-500 hover:from-emerald-700 hover:to-teal-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 transition-all duration-300"
        >
            Browse
